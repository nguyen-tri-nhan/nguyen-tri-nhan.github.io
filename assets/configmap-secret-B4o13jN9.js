...
1. Sự khác biệt giữa ConfigMap và Secret trong Kubernetes là gì?
1. Làm thế nào để quản lý secret an toàn trong Kubernetes production?
1. Điều gì xảy ra với pod khi bạn cập nhật ConfigMap mà chúng mount?
`;export{n as default};
